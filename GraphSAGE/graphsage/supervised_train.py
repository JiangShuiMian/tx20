...
flags.DEFINE_integer('max_degree', 64, 'maximum node degree. 最大邻居节点个数')
flags.DEFINE_integer('samples_1', 32, 'number of samples in layer 1')
flags.DEFINE_integer('samples_2', 16, 'number of samples in layer 2')
